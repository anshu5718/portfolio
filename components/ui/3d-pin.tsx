      ...
      >
        <div
          ...
          className="
            ...
            shadow-[0_8px_20px_rgba(0,0,0,0.5),0_12px_25px_rgba(250,204,21,0.12)]
            group-hover/pin:border-yellow-300/60
...
export const PinPerspective = ({
  ...
  return (
    <motion.div style={style} className="pointer-events-none  w-full h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-60 transition duration-500">
